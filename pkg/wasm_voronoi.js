...
function getImports() {
    ...
    imports.wbg.__wbg_alert_98f1a0ae471906ff = function(arg0, arg1) {
...
async function init(input, maybe_memory) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_voronoi_bg.wasm', import.meta.url);
    }
    const imports = getImports();
